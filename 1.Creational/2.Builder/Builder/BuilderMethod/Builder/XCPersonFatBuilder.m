...
@implementation XCPersonFatBuilder
...
-(void)buildHead {
    NSLog(@"开始 build 胖子的头部");
    [_header work];
}

-(void)buildBody {
    NSLog(@"开始 build 胖子的身体");
    [_body work];
}
-(void)buildArmLeft {
    NSLog(@"开始 build 胖子的左臂");
    [_arm work];
}
-(void)buildArmRight {
    NSLog(@"开始 build 胖子的右臂");
    [_arm work];
}
-(void)buildLegLeft {
    NSLog(@"开始 build 胖子的左腿");
    [_leg work];
}
-(void)buildLegRight {
    NSLog(@"开始 build 胖子的右腿");
    [_leg work];
}
